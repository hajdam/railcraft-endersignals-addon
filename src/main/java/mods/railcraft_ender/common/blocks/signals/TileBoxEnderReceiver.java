...
import mods.railcraft_ender.api.signals.EnderSignalReceiver;
...
public class TileBoxEnderReceiver extends TileBoxActionManager implements IAspectActionManager, IGuiReturnHandler, IReceiverTile, IAspectProvider {
    ...
    @Override
    public EnumEnderSignal getSignalType() {
        return EnumEnderSignal.BOX_ENDER_RECEIVER;
    }
    ...
    @Override
    public EnderSignalReceiver getReceiver() {
        return receiver;
    }
